...
from .views import irigasi, air_baku, pantai, sungai, keuangan, tahun, report, pdfdownload, statistics, pdfremove, pdfupload, searchdoc, searchqrcode, statistics_year
